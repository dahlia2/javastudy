...
public class MainClass {
	...
	/*
		...
		1. 람다식이 오직 1개의 메소드만 호출하는 경우에 불필요한 매개변수를 제거하고 사용할 수 있도록 도와주는 방식이다.
		2. 문법상으로만 매개변수가 제거되는 것이지 실제로 제거되는 것은 아니다. (매개변수로 인수를 전달할 수 있다.)
	...
	*/
	...
	public static void main(String[] args) {
		...
		// Consumer 람다식 (매개변수 num를 출력한다.)
		Consumer<Integer> consumer1 = (num) -> System.out.println(num);
		consumer1.accept(10);
		
		// Consumer 메소드 참조 (매개변수를 출력한다. -> 문법상 매개변수가 제거된 상태)
		...
		// Function 메소드 참조 (Integer.parse() 결과를 반환한다. -> 역시 어떤 값이 전달되는지는 문법상 제거된 상태)
