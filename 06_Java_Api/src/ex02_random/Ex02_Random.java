...
public class Ex02_Random {
	...
	/*
		...
		2. java.util.Random 클래스인 경우 import java.util.Random; 방식으로 사용된다.
		3. import java.util.*; 방식으로 java.util 패키지의 모든 클래스를 import를 할 수 있다.
	...
	public static void ex01() {
		...
		int randNumber3 = random.nextInt(10);  // 10개(0~9사이) 난수 발생
