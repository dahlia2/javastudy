...
public class MainClass {
	...
	/* 키워드 이름 규칙
	   1. 프로젝트: 마음대로.
	   2. 패키지: 모두 소문자로 변경. 실무에서는 회사 도메인과 앱 이름으로 작성(com.samsung.galaxy).
	...
	*/
	...
	public static void main(String[] args) {
		...
		char ch5 = '\''; // 작은 따옴표
		char ch6 = '\"'; // 큰 따옴표
		System.out.println(ch1); // [ctrl] + [alt] + [화살표]: 방향으로 복사
		...
		String name = "이현주"; // Java에서 기본 타입과 같은 사용법을 제공
